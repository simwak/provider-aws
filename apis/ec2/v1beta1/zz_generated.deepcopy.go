...
func (in *SecurityGroupObservation) DeepCopyInto(out *SecurityGroupObservation) {
	*out = *in
	if in.IngressSecurityGroupRuleIDs != nil {
		in, out := &in.IngressSecurityGroupRuleIDs, &out.IngressSecurityGroupRuleIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.EgressSecurityGroupRuleIDs != nil {
		in, out := &in.EgressSecurityGroupRuleIDs, &out.EgressSecurityGroupRuleIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
